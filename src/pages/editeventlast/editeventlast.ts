...
/**
 * Generated class for the EditeventlastPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-editeventlast',
  templateUrl: 'editeventlast.html',
})
export class EditeventlastPage {
  ...
  constructor(public loadingCtrl: LoadingController,public rest: RestProvider,public navCtrl: NavController, public navParams: NavParams) {
   ...
   this.passdata=this.navParams.get('passdata');
    ...
    // this.parts=this.navParams.get('parts')
   console.clear()
